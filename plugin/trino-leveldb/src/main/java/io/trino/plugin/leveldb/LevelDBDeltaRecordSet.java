...
public class LevelDBDeltaRecordSet
        implements DeltaRecordSet
{
    ...
    public LevelDBDeltaRecordSet(LevelDBTableHandle table, LevelDBSplit split, List<LevelDBColumnHandle> columnHandles, CommunicatorFactory commFactory)
    {
        this.table = table;
    ...
    @Override
    public DeltaRecordCursor cursor()
    {
        return new LevelDBDeltaRecordCursor(this.table, columnHandles, this.commFactory);
    }
}
