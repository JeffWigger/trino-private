        ...
        implements BlockEncoding
{
    ...
    public void writeBlock(BlockEncodingSerde blockEncodingSerde, SliceOutput sliceOutput, Block block)
    {
        ...
        if (block instanceof UpdatableIntArrayBlock){
            UpdatableIntArrayBlock uBlock = (UpdatableIntArrayBlock) block;
    ...
    public Block readBlock(BlockEncodingSerde blockEncodingSerde, SliceInput sliceInput)
    {
        ...
        if(type == STATIC) {
            ...
            sliceInput.readBytes(Slices.wrappedIntArray(values));
            return  new UpdatableIntArrayBlock(null, positionCount, valueMarker, values, nullCounter, deleteCounter);
        }
    }
    ...
    private Slice getValuesSlice(Block block)
    {
        ...
        else if (block instanceof UpdatableIntArrayBlock){
            return ((UpdatableIntArrayBlock) block).getValuesSlice();
        }
