...
// copied from Airlift's DynamicSliceOutput and modified to allow transforming a slice
// to a output slice without copying it.
...
public class VariableSliceOutput
        extends SliceOutput
{
    private static final int INSTANCE_SIZE = ClassLayout.parseClass(VariableSliceOutput.class).instanceSize();

    private Slice slice;
    private int size;

    public VariableSliceOutput(int estimatedSize)
    {
        this.slice = Slices.allocate(estimatedSize);
    }

    public VariableSliceOutput(Slice slice, int size)
    {
        this.slice = slice;
        this.size = size;
    }
    ...
    @Override
    public VariableSliceOutput appendLong(long value)
    {
        writeLong(value);
        return this;
    }
    ...
    @Override
    public VariableSliceOutput appendDouble(double value)
    {
        writeDouble(value);
        return this;
    }
    ...
    @Override
    public VariableSliceOutput appendInt(int value)
    {
        writeInt(value);
        return this;
    }
    ...
    @Override
    public VariableSliceOutput appendShort(int value)
    {
        writeShort(value);
        return this;
    }
    ...
    @Override
    public VariableSliceOutput appendByte(int value)
    {
        writeByte(value);
        return this;
    }
    ...
    @Override
    public VariableSliceOutput appendBytes(byte[] source, int sourceIndex, int length)
    {
    ...
    @Override
    public VariableSliceOutput appendBytes(byte[] source)
    {
        writeBytes(source);
        return this;
    }
    ...
    @Override
    public VariableSliceOutput appendBytes(Slice slice)
    {
        writeBytes(slice);
        return this;
    }
